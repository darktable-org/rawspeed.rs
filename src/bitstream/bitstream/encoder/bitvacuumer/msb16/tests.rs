...
fn nibble_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![52, 18, 112, 86],
        vec![52, 18, 120, 86],
        vec![52, 18, 120, 86, 0, 144],
        vec![52, 18, 120, 86, 0, 154],
        vec![52, 18, 120, 86, 176, 154],
        vec![52, 18, 120, 86, 188, 154],
...
fn sliding_0xff_prefixed_by_enumerated_nibbles_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![52, 18, 240, 95],
        vec![52, 18, 255, 86],
        vec![52, 18, 127, 86, 0, 240],
        vec![52, 18, 120, 86, 0, 255],
        vec![52, 18, 120, 86, 240, 159],
        vec![52, 18, 120, 86, 255, 154],
        ...
        vec![52, 18, 120, 86, 188, 154, 255, 222, 0, 240],
    ];
    assert_eq!(res, expected);
    Ok(())
}
