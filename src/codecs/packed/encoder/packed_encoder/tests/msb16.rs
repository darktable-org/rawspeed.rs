...
fn u8_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![12, 11, 14, 13],
        vec![12, 11, 14, 13, 0],
        vec![12, 11, 14, 13, 0, 15],
        vec![12, 11, 14, 13, 0, 15, 0],
        vec![12, 11, 14, 13, 16, 15],
        vec![12, 11, 14, 13, 16, 15, 0],
        ...
        vec![12, 11, 14, 13, 0, 15, 22, 21, 24, 23, 0, 25],
        vec![12, 11, 14, 13, 0, 15, 0, 22, 21, 24, 23, 0, 25, 0],
        vec![12, 11, 14, 13, 16, 15, 22, 21, 24, 23, 26, 25],
        vec![12, 11, 14, 13, 16, 15, 0, 22, 21, 24, 23, 26, 25, 0],
...
fn u12_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![176, 0, 0, 12],
        vec![176, 0, 0, 12, 0],
        vec![176, 0, 0, 12, 0, 208],
        vec![176, 0, 0, 12, 0, 208, 0],
        vec![176, 0, 0, 12, 14, 208],
        vec![176, 0, 0, 12, 14, 208, 0],
        vec![176, 0, 0, 12, 14, 208, 240, 0],
        vec![176, 0, 0, 12, 14, 208, 240, 0, 0],
        vec![176, 0, 0, 12, 14, 208, 240, 0, 0, 16],
        vec![176, 0, 0, 12, 14, 208, 240, 0, 0, 16, 0],
        ...
        vec![176, 0, 0, 12, 0, 208, 80, 1, 1, 22, 0, 112],
        vec![176, 0, 0, 12, 0, 208, 0, 80, 1, 1, 22, 0, 112, 0],
        vec![176, 0, 0, 12, 14, 208, 80, 1, 1, 22, 24, 112],
        vec![176, 0, 0, 12, 14, 208, 0, 80, 1, 1, 22, 24, 112, 0],
        vec![
        ...
        vec![
            176, 0, 0, 12, 14, 208, 240, 0, 0, 16, 80, 1, 1, 22, 24, 112, 144,
            1, 0, 26,
        ],
        vec![
            176, 0, 0, 12, 14, 208, 240, 0, 0, 16, 0, 80, 1, 1, 22, 24, 112,
            144, 1, 0, 26, 0,
        ],
        vec![
