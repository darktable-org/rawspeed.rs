...
fn u4_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![33, 3, 0, 84, 6, 0],
        vec![33, 67, 101, 135],
        vec![33, 67, 0, 101, 135, 0],
        vec![33, 67, 5, 118, 152, 10],
        vec![33, 67, 5, 0, 118, 152, 10, 0],
        vec![33, 67, 101, 135, 169, 203],
...
fn u16_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![11, 0, 12, 0, 13, 0, 0, 21, 0, 22, 0, 23, 0, 0],
        vec![11, 0, 12, 0, 13, 0, 14, 0, 21, 0, 22, 0, 23, 0, 24, 0],
        vec![11, 0, 12, 0, 13, 0, 14, 0, 0, 21, 0, 22, 0, 23, 0, 24, 0, 0],
        vec![
            11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 21, 0, 22, 0, 23, 0, 24, 0, 25,
            0,
        ],
        vec![
            11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 0, 21, 0, 22, 0, 23, 0, 24, 0,
            25, 0, 0,
        ],
        vec![
        ...
        vec![
            11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 16, 0, 17, 0, 21, 0, 22, 0, 23,
            0, 24, 0, 25, 0, 26, 0, 27, 0,
        ],
        vec![
            11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 16, 0, 17, 0, 0, 21, 0, 22, 0,
            23, 0, 24, 0, 25, 0, 26, 0, 27, 0, 0,
        ],
        vec![
...
fn u12_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![11, 192, 0, 13, 0],
        vec![11, 192, 0, 13, 0, 0],
        vec![11, 192, 0, 13, 224, 0],
        vec![11, 192, 0, 13, 224, 0, 0],
        vec![11, 192, 0, 13, 224, 0, 15, 0],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 0],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 1],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 1, 0],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 1, 17, 0],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 1, 17, 0, 0],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 1, 17, 32, 1],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 1, 17, 32, 1, 0],
        vec![11, 0, 21, 0],
        vec![11, 0, 0, 21, 0, 0],
        vec![11, 192, 0, 21, 96, 1],
        vec![11, 192, 0, 0, 21, 96, 1, 0],
        vec![11, 192, 0, 13, 0, 21, 96, 1, 23, 0],
        vec![11, 192, 0, 13, 0, 0, 21, 96, 1, 23, 0, 0],
        vec![11, 192, 0, 13, 224, 0, 21, 96, 1, 23, 128, 1],
        vec![11, 192, 0, 13, 224, 0, 0, 21, 96, 1, 23, 128, 1, 0],
        vec![11, 192, 0, 13, 224, 0, 15, 0, 21, 96, 1, 23, 128, 1, 25, 0],
        vec![
            11, 192, 0, 13, 224, 0, 15, 0, 0, 21, 96, 1, 23, 128, 1, 25, 0, 0,
        ],
        vec![
            11, 192, 0, 13, 224, 0, 15, 0, 1, 21, 96, 1, 23, 128, 1, 25, 160, 1,
        ],
        vec![
            11, 192, 0, 13, 224, 0, 15, 0, 1, 0, 21, 96, 1, 23, 128, 1, 25,
            160, 1, 0,
        ],
        vec![
            11, 192, 0, 13, 224, 0, 15, 0, 1, 17, 0, 21, 96, 1, 23, 128, 1, 25,
            160, 1, 27, 0,
        ],
        vec![
