...
fn u8_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![11, 12, 13, 14, 0],
        vec![11, 12, 13, 14, 15],
        vec![11, 12, 13, 14, 15, 0],
        vec![11, 12, 13, 14, 15, 16],
        vec![11, 12, 13, 14, 15, 16, 0],
        ...
        vec![11, 12, 21, 22],
        vec![11, 12, 0, 21, 22, 0],
        vec![11, 12, 13, 21, 22, 23],
        vec![11, 12, 13, 0, 21, 22, 23, 0],
        vec![11, 12, 13, 14, 21, 22, 23, 24],
        vec![11, 12, 13, 14, 0, 21, 22, 23, 24, 0],
        vec![11, 12, 13, 14, 15, 21, 22, 23, 24, 25],
        vec![11, 12, 13, 14, 15, 0, 21, 22, 23, 24, 25, 0],
        vec![11, 12, 13, 14, 15, 16, 21, 22, 23, 24, 25, 26],
        vec![11, 12, 13, 14, 15, 16, 0, 21, 22, 23, 24, 25, 26, 0],
        vec![11, 12, 13, 14, 15, 16, 17, 21, 22, 23, 24, 25, 26, 27],
...
fn u4_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![18, 48, 0, 69, 96, 0],
        vec![18, 52, 86, 120],
        vec![18, 52, 0, 86, 120, 0],
        vec![18, 52, 80, 103, 137, 160],
...
fn u16_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![0, 11, 0, 12, 0, 13, 0, 21, 0, 22, 0, 23],
        vec![0, 11, 0, 12, 0, 13, 0, 0, 21, 0, 22, 0, 23, 0],
        vec![0, 11, 0, 12, 0, 13, 0, 14, 0, 21, 0, 22, 0, 23, 0, 24],
        vec![0, 11, 0, 12, 0, 13, 0, 14, 0, 0, 21, 0, 22, 0, 23, 0, 24, 0],
        vec![
            0, 11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 21, 0, 22, 0, 23, 0, 24, 0,
            25,
        ],
        vec![
            0, 11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 0, 21, 0, 22, 0, 23, 0, 24,
            0, 25, 0,
        ],
        vec![
        ...
        vec![
            0, 11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 16, 0, 17, 0, 21, 0, 22, 0,
            23, 0, 24, 0, 25, 0, 26, 0, 27,
        ],
        vec![
            0, 11, 0, 12, 0, 13, 0, 14, 0, 15, 0, 16, 0, 17, 0, 0, 21, 0, 22,
...
fn u12_enumeration_test() -> std::io::Result<()> {
    ...
    let expected: Vec<Vec<u8>> = vec![
        ...
        vec![0, 176, 12, 0],
        vec![0, 176, 12, 0, 208],
        vec![0, 176, 12, 0, 208, 0],
        vec![0, 176, 12, 0, 208, 14],
        vec![0, 176, 12, 0, 208, 14, 0],
        vec![0, 176, 12, 0, 208, 14, 0, 240],
        vec![0, 176, 12, 0, 208, 14, 0, 240, 0],
        vec![0, 176, 12, 0, 208, 14, 0, 240, 16],
        vec![0, 176, 12, 0, 208, 14, 0, 240, 16, 0],
        vec![0, 176, 12, 0, 208, 14, 0, 240, 16, 1, 16],
        vec![0, 176, 12, 0, 208, 14, 0, 240, 16, 1, 16, 0],
        vec![0, 176, 12, 0, 208, 14, 0, 240, 16, 1, 16, 18],
        vec![0, 176, 12, 0, 208, 14, 0, 240, 16, 1, 16, 18, 0],
        vec![0, 176, 1, 80],
        vec![0, 176, 0, 1, 80, 0],
        vec![0, 176, 12, 1, 80, 22],
        vec![0, 176, 12, 0, 1, 80, 22, 0],
        vec![0, 176, 12, 0, 208, 1, 80, 22, 1, 112],
        vec![0, 176, 12, 0, 208, 0, 1, 80, 22, 1, 112, 0],
        vec![0, 176, 12, 0, 208, 14, 1, 80, 22, 1, 112, 24],
        vec![0, 176, 12, 0, 208, 14, 0, 1, 80, 22, 1, 112, 24, 0],
        vec![
        ...
        vec![
            0, 176, 12, 0, 208, 14, 0, 240, 16, 1, 80, 22, 1, 112, 24, 1, 144,
            26,
        ],
        vec![
            0, 176, 12, 0, 208, 14, 0, 240, 16, 0, 1, 80, 22, 1, 112, 24, 1,
            144, 26, 0,
        ],
        vec![
            0, 176, 12, 0, 208, 14, 0, 240, 16, 1, 16, 1, 80, 22, 1, 112, 24,
            1, 144, 26, 1, 176,
        ],
        vec![
