...
fn parse_test() {
    ...
    let expected: Vec<(&str, xmlparser::Result<T>)> = vec![
        ...
        (
            "<Crop x=\"0\" y=\"0\" width=\"0\" height=\"0\"/>",
            Ok(Crop::new(
                super::AbsoluteCropPosition::new(Coord2D::new(
                    RowIndex::new(0),
                    ColIndex::new(0),
                )),
                super::CropSize::Relative(CoordOffset2D::new(
                    RowOffset::new(0),
                    ColOffset::new(0),
                )),
            )),
        ...
        (
            ...
            Ok(Crop::new(
                ...
                super::CropSize::Absolute(Dimensions2D::new(
                    RowLength::new(1),
                    RowCount::new(1),
                )),
            )),
